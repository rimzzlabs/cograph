/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5055542819a9effe0db8b10361968f48)
// Runtime types generated with workerd@1.20260826.1 2026-08-27 
interface __BaseEnv_Env {
	ROOM: DurableObjectNamespace<import("./worker/index").RoomDurableObject>;
	DIRECTORY: DurableObjectNamespace<import("./worker/index").RoomsDirectoryDurableObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "RoomDurableObject" | "RoomsDirectoryDurableObject";
	}
