...
export function LandingHero() {
  return (
    <section className="landing-glow-field landing-grain">
      <div className="mx-auto grid w-full max-w-6xl items-center gap-12 px-6 pt-14 pb-24 lg:grid-cols-[minmax(0,6fr)_minmax(0,5fr)] lg:pt-20">
        <div className="min-w-0">
          <h1
            className="landing-rise wrap-anywhere font-landing-display font-semibold text-[clamp(2.4rem,4.2vw+0.6rem,4rem)] text-ink leading-[1.1] tracking-tight"
